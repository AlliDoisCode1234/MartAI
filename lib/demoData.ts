  ...
  const keywordClusters: KeywordCluster[] = [
    {
      ...
      intent: 'commercial',
      difficulty: 52,
      volumeRange: { min: 400, max: 1200 },
      impactScore: 0.78,
      topSerpUrls: ['https://example.com/solutions'],
      status: 'active',
      createdAt: Date.now(),
      updatedAt: Date.now(),
    },
    {
      ...
      difficulty: 38,
      volumeRange: { min: 250, max: 900 },
      impactScore: 0.64,
      topSerpUrls: ['https://example.com/pain-points'],
      status: 'active',
      createdAt: Date.now(),
      updatedAt: Date.now(),
    },
    {
      ...
      difficulty: 45,
      volumeRange: { min: 300, max: 800 },
      impactScore: 0.7,
      topSerpUrls: ['https://example.com/roi'],
      status: 'active',
      createdAt: Date.now(),
      updatedAt: Date.now(),
    },
