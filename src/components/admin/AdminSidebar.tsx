...
import { FiHome, FiUsers, FiActivity, FiSettings, FiBarChart2, FiCpu, FiShield } from 'react-icons/fi';
...
const NAV_ITEMS = [
  ...
  { name: 'Security/Staff', icon: FiShield, path: '/admin/staff', roles: ['super_admin'] },
  {
    name: 'Keywords',
    icon: FiActivity,
    path: '/admin/keywords',
