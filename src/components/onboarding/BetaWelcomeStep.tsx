...
export function BetaWelcomeStep({ formData, onFormChange, onNext, loading }: Props) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === 'Enter' && formData.website?.trim() && !loading) {
      e.preventDefault();
      onNext();
    }
  };
          ...
          <HStack spacing={4} align="start">
            ...
            <Box>
              <Heading size="lg" mb={2}>
                Welcome to the Phoo.ai Beta
              </Heading>
              <Text color="gray.600">
                Thank you for being a Founding Member! Enter your website below and I&apos;ll
