          ...
          <VStack align="stretch" spacing={8}>
            ...
            <Section title="Introduction">
              <Text>
                ...
                and safeguard your information when you use our AI-powered content generation and
                SEO platform (&ldquo;Service&rdquo;).
              </Text>
              <Text>
            ...
            <Section title="Information We Collect">
              ...
              <SubSection title="Third-Party Integration Data">
                ...
                <UnorderedList pl={4} spacing={1}>
                  ...
                  <ListItem>
                    <strong>WordPress/Shopify/Wix:</strong> Blog post publishing credentials and
                    site information
                  </ListItem>
                  <ListItem>
            ...
            <Section title="AI and Machine Learning">
              ...
              <UnorderedList pl={4} spacing={2}>
                <ListItem>
                  ...
                  processed by AI models to generate content. We do not use your generated content
                  to train our AI models without explicit consent.
                </ListItem>
                <ListItem>
                  <strong>Third-Party AI Providers:</strong> We use services like OpenAI and Google
                  to power our AI features. These providers have their own privacy policies and data
                  handling practices.
                </ListItem>
                <ListItem>
            ...
            <Section title="Data Retention">
              <Text>
                ...
                our Service. You can delete your account at any time, which will remove your
