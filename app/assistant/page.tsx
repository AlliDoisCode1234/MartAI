            ...
            >
              <Box flex={1} overflowY="auto" mb={4} p={4} bg="brand.light" borderRadius="md">
                <VStack spacing={4} align="stretch">
                  ...
                  >
                    <Text fontSize="sm">
                      Based on your analytics, I recommend focusing on long-tail variations and
                      creating pillar content around "SEO automation for small businesses". Here's a
                      strategy...
                    </Text>
                  </Box>
                </VStack>
              ...
              <HStack>
                ...
                <Button bg="brand.orange" color="white" _hover={{ bg: '#E8851A' }}>
                  Send
                </Button>
              </HStack>
            </Box>
