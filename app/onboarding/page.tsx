                  ...
                  <VStack spacing={6} align="stretch">
                    ...
                    <VStack spacing={4} align="stretch">
                      <Button
                        ...
                        onClick={async () => {
                          // For now, show info that OAuth is coming soon
                          // When we have projectId, we can trigger:
                          // window.open(`/api/oauth/google?type=ga4&projectId=${projectId}`, '_blank')
                          alert(
                            'GA4 OAuth connection will be fully wired in the integrations page after onboarding. You can connect there once your project is created.'
                          );
                        }}
                        isDisabled={true}
                        _disabled={{
                      ...
                      <Text fontSize="xs" color="gray.500" textAlign="center">
                        You can connect GA4 from the Integrations page after completing onboarding.
                        This allows Mart to access your real traffic data for better
                        recommendations.
                      </Text>
                    </VStack>
                    ...
                    <HStack justify="space-between" pt={4}>
                      ...
                      <Button
                        ...
                        rightIcon={<FiArrowRight />}
                        onClick={async () => {
                          // GA4 connection is optional - users can connect later in Integrations
                          setStep(5);
                          handleSubmit();
                        }}
                        size="lg"
