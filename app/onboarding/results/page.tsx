...
export default function ResultsPage() {
  ...
  const socialMedia = analysis.toolResults?.find(
    (r) => r.toolName === 'generateSocialMediaPosts'
  )?.result;
        ...
        <VStack spacing={8} align="stretch">
          ...
          {analysis.finalAnswer && (
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4} fontFamily="heading" color="brand.orange">
                Executive Summary
              </Heading>
          ...
          {seoAudit && (
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="xl" mb={6} fontFamily="heading" color="gray.800">
                SEO Audit Results
              </Heading>
              ...
              <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)' }} gap={6} mb={6}>
                <GridItem>
                  ...
                  >
                    ...
                    <Heading size="lg" color="brand.orange" mb={3}>
                      {seoAudit.technicalSeo.score}/100
                    </Heading>
                ...
                <GridItem>
                  ...
                  >
                    ...
                    <Heading size="lg" color="brand.teal" mb={3}>
                      {seoAudit.onPageSeo.score}/100
                    </Heading>
                    <VStack align="stretch" spacing={2}>
                ...
                <GridItem>
                  ...
                  >
                    ...
                    <Heading size="lg" color="brand.orange" mb={3}>
                      {seoAudit.contentQuality.score}/100
                    </Heading>
                    <VStack align="stretch" spacing={2}>
          ...
          {content && (
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              ...
              <Box mb={6}>
                <Heading size="md" mb={4} fontFamily="heading" color="brand.teal">
                ...
                <VStack align="stretch" spacing={4}>
                  {content.seoSuggestions.map((suggestion: any, i: number) => (
                    <Box
                      ...
                      borderRadius="md"
                    >
                      <Text fontWeight="bold" mb={2} color="brand.teal">
                        {suggestion.keyword}
                      </Text>
                      ...
                      <Badge bg="brand.teal" color="white" fontSize="xs">
                        {suggestion.contentAngle}
                      </Badge>
                    </Box>
                  ))}
                </VStack>
                ...
                {socialMedia.linkedin && (
                  <GridItem>
                    <Box
                      ...
                      borderRadius="md"
                    >
                      <Heading size="sm" mb={3} fontFamily="heading" color="brand.teal">
                        LinkedIn
                      </Heading>
                        ...
                        <Box key={i} mb={4} p={3} bg="white" borderRadius="md">
                          ...
                          <HStack spacing={2} flexWrap="wrap">
                            {post.hashtags.map((tag: string, j: number) => (
                              <Badge key={j} bg="brand.teal" color="white" fontSize="xs">
                                {tag}
                              </Badge>
                            ))}
                          </HStack>
                ...
                {socialMedia.twitter && (
                  <GridItem>
                    <Box
                      ...
                      borderRadius="md"
                    >
                      <Heading size="sm" mb={3} fontFamily="heading" color="brand.orange">
                        Twitter/X
                      </Heading>
                      {socialMedia.twitter.map((post: any, i: number) => (
                        <Box key={i} mb={4} p={3} bg="white" borderRadius="md">
                          <Text fontSize="sm" mb={2} whiteSpace="pre-line">
                            {post.post}
                          </Text>
                          <HStack spacing={2} flexWrap="wrap">
                            {post.hashtags.map((tag: string, j: number) => (
                              <Badge key={j} bg="brand.orange" color="white" fontSize="xs">
                                {tag}
                              </Badge>
                            ))}
                          </HStack>
                ...
                {socialMedia.instagram && (
                  <GridItem>
                    <Box
                      ...
                      borderRadius="md"
                    >
                      <Heading size="sm" mb={3} fontFamily="heading" color="brand.lavender">
                        Instagram
                      </Heading>
                      {socialMedia.instagram.map((post: any, i: number) => (
                        <Box key={i} mb={4} p={3} bg="white" borderRadius="md">
                          ...
                          <HStack spacing={2} flexWrap="wrap">
                            {post.hashtags.map((tag: string, j: number) => (
                              <Badge key={j} bg="brand.lavender" color="white" fontSize="xs">
                                {tag}
                              </Badge>
                            ))}
                          </HStack>
