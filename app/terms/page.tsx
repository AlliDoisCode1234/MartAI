          ...
          <VStack align="stretch" spacing={8}>
            ...
            <Section title="Agreement to Terms">
              <Text>
                ...
                Phoo.ai (&ldquo;Service&rdquo;), operated by Phoo.ai (&ldquo;we,&rdquo;
                &ldquo;our,&rdquo; or &ldquo;us&rdquo;). By accessing or using our Service, you
                agree to be bound by these Terms.
              </Text>
              <Text>
                If you do not agree to these Terms, you may not access or use the Service. We
                reserve the right to update these Terms at any time, and your continued use
            ...
            <Section title="AI-Generated Content">
              ...
              <UnorderedList pl={4} spacing={2}>
                ...
                <ListItem>
                  <strong>Ownership:</strong> Subject to these Terms, you own the content you
                  generate using our Service
                </ListItem>
                <ListItem>
                  <strong>Compliance:</strong> You are responsible for ensuring content complies
                  with applicable laws and third-party platform policies
                </ListItem>
              </UnorderedList>
            </Section>
            ...
            <Section title="Intellectual Property">
              ...
              <SubSection title="Our Content">
                <Text>
                  ...
                  Phoo.ai and protected by intellectual property laws. You may not copy, modify,
            ...
            <Section title="Limitation of Liability">
              <Text>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, PHOO.AI SHALL NOT BE LIABLE FOR ANY
            ...
            <Section title="Indemnification">
              <Text>
                You agree to indemnify, defend, and hold harmless Phoo.ai and its officers,
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <Box>
      ...
      <VStack align="stretch" spacing={4} color="gray.600" fontSize="md" lineHeight="1.8">
        {children}
      </VStack>
    </Box>
  );
