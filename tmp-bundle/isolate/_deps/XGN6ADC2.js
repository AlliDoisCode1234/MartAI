...
// convex/phoo/industryTemplates.ts
T();
var o = {
  medSpa: {
    id: "medSpa",
  ...
  args: {
    ...
    businessDescription: t.optional(t.string())
  },
  handler: /* @__PURE__ */ i(async (n, e) => {
    let r = [e.url || "", e.content || "", e.businessDescription || ""].join(" ").toLowerCase(), a = [];
    for (let [s, c] of Object.entries(o)) {
      if (s === "general") continue;
      let p = c.detectionPatterns.reduce((d, y) => {
        let u = new RegExp(y, "gi"), h = (r.match(u) || []).length;
        return d + h;
      }, 0);
      p > 0 && a.push({ id: s, score: p });
    }
    return a.sort((s, c) => c.score - s.score), a.length > 0 ? a[0].id : "general";
  }, "handler")
}), v = m({
  args: {},
  handler: /* @__PURE__ */ i(async () => Object.values(o).map(({ id: n, name: e, description: r }) => ({
    id: n,
    name: e,
    description: r
  })), "handler")
  ...
  handler: /* @__PURE__ */ i(async (n, e) => o[e.industryId] || o.general, "handler")
}), K = l({
  args: {
    industryId: t.string()
  },
  handler: /* @__PURE__ */ i(async (n, e) => (o[e.industryId] || o.general).contentPlan, "handler")
});
...
//# sourceMappingURL=XGN6ADC2.js.map
